...
def _inline_markup(text: str) -> str:
    ...
    value = re.sub(r"(https?://[^\s<]+)", r"<link href='\1' color='#3467eb'>\1</link>", value)
...
def render_pdf(markdown: str, output_path: Path, title: str) -> int:
    ...
    for raw_line in markdown.splitlines():
        ...
        if line.startswith("# "):
            ...
            style = styles["SourceX"] if bibliography or line.startswith("[S") else styles["BodyX"]
